...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            # STEP 1: Navigate to https://en.wikipedia.org/
            current_step = 1
            current_selector = None
            navigate(page, "https://en.wikipedia.org/", 30000)

            # STEP 2: Type 'OpenAI' into the Wikipedia search input field.
            current_step = 2
            current_selector = "#searchInput"
            safe_fill(page, "#searchInput", "OpenAI", 5000)

            # STEP 3: Click the 'Search' button to submit the search for 'OpenAI'.
            current_step = 3
            current_selector = "button:has-text('Search')"
            safe_click(page, "button:has-text('Search')", 5000)

            # STEP 4: Click on the 'Corporate structure' link to navigate to that section.
            current_step = 4
            current_selector = "a:has-text('Corporate structure')"
            safe_click(page, "a:has-text('Corporate structure')", 5000)

            # STEP 5: Click on the 'holding company' link to navigate to that section.
            current_step = 5
            current_selector = "a:has-text('holding company')"
            safe_click(page, "a:has-text('holding company')", 5000)

            # STEP 6: Click on the 'United Kingdom' link to navigate to that section.
            current_step = 6
            current_selector = "a:has-text('United Kingdom')"
            safe_click(page, "a:has-text('United Kingdom')", 5000)
