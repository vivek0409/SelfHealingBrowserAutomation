...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            current_step = 1
            current_selector = None
            navigate(page, "https://books.toscrape.com/", 30000)

            # STEP 2: Click on the 'History' category link to navigate to the History section.
            current_step = 2
            current_selector = "a:has-text('History')"
            safe_click(page, "a:has-text('History')", 5000)

            # STEP 3: Click on 'Sapiens: A Brief History of Humankind' to view the book details.
            current_step = 3
            current_selector = "a:has-text('Sapiens: A Brief History ...')"
            safe_click(page, "a:has-text('Sapiens: A Brief History ...')", 5000)
