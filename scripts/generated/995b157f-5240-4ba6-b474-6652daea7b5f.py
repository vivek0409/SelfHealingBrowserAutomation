...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # STEP 7: Fill in the date of birth field with '01 Jan 2000'.
            current_step = 7
            current_selector = "#dateOfBirthInput"
            safe_fill(page, "#dateOfBirthInput", "01 Jan 2000", 5000)

            # STEP 8: Fill in the subjects field with 'Maths'.
            current_step = 8
            current_selector = "#subjectsInput"
            safe_fill(page, "#subjectsInput", "Maths", 5000)

            # STEP 9: Click the 'Submit' button to submit the form.
            current_step = 9
