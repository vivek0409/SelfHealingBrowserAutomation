...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # STEP 7: Fill the date of birth field with '14 Jun 1990'.
            current_step = 7
            current_selector = "#dateOfBirthInput"
            safe_fill(page, "#dateOfBirthInput", "14 Jun 1990", 5000)

            # STEP 8: Fill the subjects field with 'Maths'.
            current_step = 8
            current_selector = "#subjectsInput"
            safe_fill(page, "#subjectsInput", "Maths", 5000)
            ...
            # STEP 10: Fill the current address field with '123 Main St, Anytown, USA'.
            current_step = 10
