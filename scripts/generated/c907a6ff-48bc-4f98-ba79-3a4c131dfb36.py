...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            current_step = 1
            current_selector = None
            navigate(page, "https://www.amazon.in/", 30000)

            # STEP 2: Type 'laptop' into the search box.
            current_step = 2
            current_selector = "#twotabsearchtextbox"
            safe_fill(page, "#twotabsearchtextbox", "laptop", 5000)

            # STEP 3: Click the 'Go' button to submit the search for laptops.
            current_step = 3
            current_selector = "#nav-search-submit-button"
            safe_click(page, "#nav-search-submit-button", 5000)
