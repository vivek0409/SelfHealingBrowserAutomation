...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            safe_fill(page, "#fname", "John", 5000)
            ...
            # STEP 4: Fill the 'Email' field with 'jane.doe@example.com'.
            current_step = 4
            current_selector = "#email"
            safe_fill(page, "#email", "jane.doe@example.com", 5000)

            # STEP 5: Fill the 'Phone' field with '+1 555 000 0000'.
            current_step = 5
            current_selector = "#phone"
            safe_fill(page, "#phone", "+1 555 000 0000", 5000)

            # STEP 6: Fill the 'Password' field with 'password123'.
            current_step = 6
            current_selector = "#pwd"
            safe_fill(page, "#pwd", "password123", 5000)

            # STEP 7: Fill the 'Website URL' field with 'https://example.com'.
            current_step = 7
            current_selector = "#url"
            safe_fill(page, "#url", "https://example.com", 5000)

            # STEP 8: Fill the 'Date of Birth' field with '1990-01-01'.
            current_step = 8
            current_selector = "#dob"
            safe_fill(page, "#dob", "1990-01-01", 5000)

            # STEP 9: Fill the 'Quantity' field with '5'.
            current_step = 9
            current_selector = "#qty"
            safe_fill(page, "#qty", "5", 5000)

            # STEP 10: Select 'United States' from the 'Country' dropdown.
            current_step = 10
            current_selector = "#country"
            safe_select(page, "#country", "United States", 5000)

            # STEP 11: Fill the 'Bio' field with a brief description.
            current_step = 11
            current_selector = "#bio2"
            safe_fill(page, "#bio2", "I am a software developer with a passion for creating innovative solutions.", 5000)
            ...
            # STEP 13: Click the 'Submit Form' button to submit the form.
            current_step = 13
