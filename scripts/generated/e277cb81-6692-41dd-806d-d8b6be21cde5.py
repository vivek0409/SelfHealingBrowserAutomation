...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            current_step = 1
            current_selector = None
            navigate(page, "https://demoqa.com/automation-practice-form", 30000)

            # STEP 2: Fill in the first name field with 'John'.
            current_step = 2
            current_selector = "#firstName"
            safe_fill(page, "#firstName", "John", 5000)

            # STEP 3: Fill in the last name field with 'Doe'.
            current_step = 3
            current_selector = "#lastName"
            safe_fill(page, "#lastName", "Doe", 5000)

            # STEP 4: Fill in the email field with 'john.doe@example.com'.
            current_step = 4
            current_selector = "#userEmail"
            safe_fill(page, "#userEmail", "john.doe@example.com", 5000)

            # STEP 5: Fill in the mobile number field with '1234567890'.
            current_step = 5
            current_selector = "#userNumber"
            safe_fill(page, "#userNumber", "1234567890", 5000)

            # STEP 6: Select the 'Male' gender radio button.
            current_step = 6
            current_selector = "#gender-radio-1"
            safe_click(page, "#gender-radio-1", 5000)

            # STEP 7: Fill in the date of birth field with '14 Jun 1990'.
            current_step = 7
            current_selector = "#dateOfBirthInput"
            safe_fill(page, "#dateOfBirthInput", "14 Jun 1990", 5000)

            # STEP 8: Fill in the subjects field with 'Math'.
            current_step = 8
            current_selector = "#subjectsInput"
            safe_fill(page, "#subjectsInput", "Math", 5000)

            # STEP 9: Select 'Maths' from the subjects dropdown.
            current_step = 9
            current_selector = "#react-select-2-option-0"
            safe_click(page, "#react-select-2-option-0", 5000)

            # STEP 10: Select the 'Sports' hobby checkbox.
            current_step = 10
            current_selector = "#hobbies-checkbox-1"
            safe_click(page, "#hobbies-checkbox-1", 5000)

            # STEP 11: Fill in the current address field with '123 Main St, Anytown, USA'.
            current_step = 11
            current_selector = "#currentAddress"
            safe_fill(page, "#currentAddress", "123 Main St, Anytown, USA", 5000)

            # STEP 12: Click the 'Submit' button to submit the form.
            current_step = 12
            current_selector = "#submit"
            safe_click(page, "#submit", 5000)
